...
def extract_all_totals(html_text: str) -> dict:
    ...
    return {
        ...
        # SATCAT totals
        "tracked_objects_total": int(all_total),
        "tracked_objects_on_orbit": int(all_on_orbit),
        "payloads_on_orbit": int(payloads_on_orbit),
        "debris_on_orbit": int(debris_on_orbit),

        # Notes
        "notes": (
            "Generated by backend/tools/update_tracked_totals.py. "
            "Source: CelesTrak SATCAT Boxscore. "
